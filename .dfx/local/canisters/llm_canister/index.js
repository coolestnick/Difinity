...
import { idlFactory } from './llm_canister.did.js';
export { idlFactory } from './llm_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LLM_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./llm_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the llm_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./llm_canister.did.js")._SERVICE>}
 */
export const llm_canister = createActor(canisterId);
